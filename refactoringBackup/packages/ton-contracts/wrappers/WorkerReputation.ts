...
export class WorkerReputation implements Contract {
    ...
    async sendRegisterWorker(provider: ContractProvider, via: Sender, params: {
        worker: Address;
    }) {
        await provider.internal(via, {
            value: toNano('0.1'),
    ...
    async sendUpdateReputation(provider: ContractProvider, via: Sender, params: {
        worker: Address;
        qualityScore: number;
    ...
    async sendApplyPenalty(provider: ContractProvider, via: Sender, params: {
        worker: Address;
