...
async function main() {
    ...
    const result = await compileFunc({
        ...
        sources: {
            'src/MindBurnPayments.fc': readFileSync(join(__dirname, '../src/MindBurnPayments.fc'), 'utf8'),
            ...
            'src/imports/op-codes.fc': readFileSync(join(__dirname, '../src/imports/op-codes.fc'), 'utf8'),
        },
        optLevel: 3,
    });
    ...
    await writeFile(
        join('build', 'MindBurnPayments.abi.json'),
